...
//  6. Create a new variable -- message -- which you'll use to build a complete message to print to the document
...
//     "<h1>Math  with the numbers 3 and 4</h1>" where the two numbers are the values input from the user. Use string concatenation to create this
//     and make sure you actually perform the math on the values by using the + symbol to add their values together.

const message = `<h1>"Math with the numbers ${numberA} and ${numberB}</h1>
